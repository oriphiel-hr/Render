-- View: samo promjene po mbs – redovi gdje se scn za taj mbs razlikuje od prethodnog snapshot_id.
...
COMMENT ON VIEW sudreg_promjene_razlike IS 'Razlike po mbs i scn između uzastopnih snapshot_id; scn_changed = true kada je scn drugačiji od prethodnog snapshota. Prema Sudreg API /promjene.';
