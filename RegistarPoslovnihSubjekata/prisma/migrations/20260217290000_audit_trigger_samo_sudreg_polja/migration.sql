-- Trigger rps_sudreg_audit_promjene: uspoređuj samo polja koja dolaze iz Sudskog registra.
-- Izostavi: snapshot_id, created_at, updated_at, modified_at, glava_id (naša/timestamp polja).
...
DECLARE
  ...
  izvor_val text;
  j json;
  skip_cols text[] := ARRAY['snapshot_id', 'created_at', 'updated_at', 'modified_at', 'glava_id'];
BEGIN
