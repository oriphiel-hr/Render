# 🚀 KOPIRAJTE OVO U CLOUDSHELL

## Korak 1: U CloudShell napravite datoteku

```bash
cat > add-categories.sh << 'SCRIPTEND'
#!/bin/bash
export DATABASE_URL="postgres://uslugar_user:Pastor123@uslugar-db.cr80o0eeg3gy.eu-north-1.rds.amazonaws.com:5432/uslugar"

echo "Starting to add categories..."
...
chmod +x add-categories.sh
./add-categories.sh
```

---

## ILI direktno pokrenite ove naredbe

Kopirajte i pokrenite u CloudShell:

```bash
export DATABASE_URL="postgres://uslugar_user:Pastor123@uslugar-db.cr80o0eeg3gy.eu-north-1.rds.amazonaws.com:5432/uslugar"
```

Zatim kopirajte svaku SQL naredbu i pokrenite jednu po jednu (ukupno 4 naredbe dolje):
