...
$env:TEST_EMAIL_KORISNIK = "milan.babic@uslugar.hr"
$env:TEST_PASSWORD_KORISNIK = $pass

$env:TEST_EMAIL_PRUVATELJ = "marko.kovac@uslugar.hr"
$env:TEST_PASSWORD_PRUVATELJ = $pass

$env:TEST_EMAIL_TIM_CLAN = "petra.novak@uslugar.hr"
$env:TEST_PASSWORD_TIM_CLAN = $pass

$env:TEST_EMAIL_DIREKTOR = "ivan.babic@uslugar.hr"
