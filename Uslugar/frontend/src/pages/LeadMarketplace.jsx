...
const DEMO_LEADS = [
  {
    ...
    budgetMax: 1300,
    leadPrice: 3,
    leadPriceBreakdown: { fixedEUR: 4, percentEUR: 20, jobValueEUR: 1000, totalEUR: 24, percent: 2 },
    qualityScore: 82,
    urgency: 'HIGH',
    distanceKm: 3,
    user: {
  ...
  },
  {
    ...
    budgetMax: 2800,
    leadPrice: 5,
    leadPriceBreakdown: { fixedEUR: 4, percentEUR: 43, jobValueEUR: 2150, totalEUR: 47, percent: 2 },
    qualityScore: 76,
    urgency: 'NORMAL',
    distanceKm: 15,
    user: {
  ...
  },
  {
    ...
    budgetMax: 2200,
    leadPrice: 4,
    leadPriceBreakdown: { fixedEUR: 4, percentEUR: 34, jobValueEUR: 1700, totalEUR: 38, percent: 2 },
    qualityScore: 65,
    urgency: 'URGENT',
    distanceKm: 7,
    user: {
