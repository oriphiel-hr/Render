# 🚀 DODAJ KATEGORIJE - AWS CONSOLE (RUČNO)

## Problem

ECS Exec nije konfiguriran (nedostaje taskRoleArn), pa koristimo AWS Console manual pristup.
...
Otvori link: https://console.aws.amazon.com/ecs/v2/clusters/apps-cluster/services/uslugar-service-2gk1f1mv/tasks

### 2️⃣ Klikni na Running Task

Klikni na **zelenu točku** (running task).

### 3️⃣ Klikni Connect

Gornji desni kut → Klikni **"Connect"** button.

### 4️⃣ Odaberi Execute Command

U dropdownu odaberi **"Execute Command"**.
...
Kopiraj i pokreni **jednu po jednu**:
...
Sve 58 kategorija su dodane (neaktivne po defaultu).
